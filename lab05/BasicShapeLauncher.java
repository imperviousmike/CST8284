...
public class BasicShapeLauncher {
	...
	public static void main(String[] args) {
		...
		System.out.println("The default square is " + (defaultSquare.equals(square) ? "" : "NOT ")
				+ "equal to a square of width 2.0");

		System.out.println("A triangle is " + (triangle.equals(triangle) ? "" : "NOT ") + "equal to itself");
		System.out.println("The copy constructor triangle is " + (triangle.equals(triangle1) ? "" : "NOT ")
				+ "equal to its source triangle");
