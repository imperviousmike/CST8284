...
public abstract class Room {
	...
	/**
	 * Constructs a {@link cst8284.asgmt4.room.Room} object. Takes the given
	 ...
	 * implemented by any subclass of {@link cst8284.asgmt4.room.Room}. It will
	 ...
	 * cst8284.asgmt4.room.Room}. It will return the number of seats of the Room
	 ...
	 * by any subclass of {@link cst8284.asgmt4.room.Room}. It will return the extra
	 ...
	 * {@link cst8284.asgmt4.room.Room} object.
	 * 
	...
	public String toString() {
		return (getRoomNumber() + "/" + getRoomType() + "/" + getSeats() + " seats/" + getDetails()).trim();
	}
}
