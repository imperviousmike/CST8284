 ...
 * {@link cst8284.asgmt3.roomScheduler.RoomBooking} that the user has entered.
 * This class implements {@code Serializable} to allow for saving and loading
 * from a file done in the {@link cst8284.asgmt3.roomScheduler.RoomScheduler}.
 * 
 * @version 1.0
 * @author Michael Daly
 * 
...
public class Activity implements Serializable {
	...
	/**
	 * Returns a reference to a formatted {@code String} of the stored values in this
	 * class. Descriptions only show when they are set so if there is no value in
	 * the description field nothing is displayed.
	 * 
